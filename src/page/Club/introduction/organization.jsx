...
export default function Organization () {
    ...
    <PageBox aniWidth={'15%'} >
        <section className='organizationArea'>
            ...
            <h3>조직도</h3>
            <p><span>인천유나이티드는 구단주인 인천광역시장과 대표이사, 단장, 사무국장의 지휘 아래 경영지원부, 마케팅부, 전력강화부 이상 3개 부서와 축구센터 부서로 조직이 나뉘어 있습니다.</span>
            경영지원부는 경영기획팀과 경기장관리팀으로 구성되어 인천유나이티드의 구단 살림 및 경기장, 훈련장 등의 운영을 책임지고 있습니다.<br />
            ...
            축구센터 부서는 인천 선학동에 있는 인천유나이티드FC 축구센터 운영 및 관리를 책임지고 있습니다.</p>
